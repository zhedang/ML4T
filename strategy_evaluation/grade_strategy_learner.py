...
strategy_test_cases = [  		  	   		 	 	 			  		 			     			  	 
    ...
    StrategyTestCase(  		  	   		 	 	 			  		 			     			  	 
        ...
        benchmark=0.1581999999999999,  # benchmark computed Nov 22 2017 0.1581999999999999
        impact=0.0,  		  	   		 	 	 			  		 			     			  	 
        train_time=25,  		  	   		 	 	 			  		 			     			  	 
        test_time=5,  		  	   		 	 	 			  		 			     			  	 
        max_time=60,  		  	   		 	 	 			  		 			     			  	 
...
def test_strategy(  		  	   		 	 	 			  		 			     			  	 
    ...
    try:  		  	   		 	 	 			  		 			     			  	 
        ...
        # tb_list = [row for row in tb_list if row[0] in ['QLearner.py','StrategyLearner_.py']]
        if tb_list:  		  	   		 	 	 			  		 			     			  	 
            msg += "Traceback:\n"  		  	   		 	 	 			  		 			     			  	 
